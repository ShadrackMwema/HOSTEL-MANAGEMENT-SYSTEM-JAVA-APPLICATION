...
public class RoomManager {
    ...
    public RoomManager() {
        ...
        JFrame studentFrame = new JFrame("Room Details");
    ...
    private static String[] getColumnNames() {
        return new String[]{ "RoomID", "NoOfStudents", "AccomodationFee", "CareTakerID", "Gents_Ladies", "Block"};
    }
    ...
    private String[][] getInitialData() {
        ...
        try {
            ...
            String query = "SELECT Block, RoomID, NoOfStudents, AccomodationFee, CareTakerID, Gents_Ladies FROM Rooms";
            ...
            while (resultSet.next()) {
                String[] rowData = new String[]{
                        ...
                        resultSet.getString("NoOfStudents"),
                        resultSet.getString("AccomodationFee"),
                        resultSet.getString("CareTakerID"),
                        resultSet.getString("Gents_Ladies")
                };
                data.add(rowData);
            }
    ...
    private static void generateReport(JTable studentTable) {
        try {
            ...
            JFreeChart chart = ChartFactory.createPieChart(
                    "Room allocation Report", // Chart title
                    dataset,              // Dataset
                    true,
                    true,
                    false
            ...
            JFrame chartFrame = new JFrame("Room allocation Report");
    ...
    private static void displayEditStudentForm(JTable studentTable, int selectedRow, String[] rowData) {
        JFrame editStudentFrame = new JFrame("Edit Room");
    ...
    private static void saveDetailsToDatabase(JTable studentTable) {
        try {
            ...
            // Insert new records
            String insertQuery = "INSERT INTO Rooms (Block, RoomID, NoOfStudents, AccomodationFee, CareTakerID, Gents_Ladies) VALUES (?, ?, ?, ?, ?, ?)";
