...
public class ManageCaretakers {
    ...
    public ManageCaretakers() {
        // Create a new JFrame to display the student table
        JFrame studentFrame = new JFrame("Caretakers Details");
    ...
    private static String[] getColumnNames() {
        return new String[]{"Names", "ID No", "Phone Number", "Salary", "No of Rooms", "Block"};
    }
    ...
    private String[][] getInitialData() {
        ...
        try {
            ...
            String query = "SELECT Names, ID_No, Phone_Number, Salary, No_of_Room, Block FROM caretakers";
            ...
            while (resultSet.next()) {
                String[] rowData = new String[]{
                        ...
                        resultSet.getString("No_of_Room"),
    ...
    private static JPanel createButtonPanel(JTable studentTable) {
        ...
        addButton(buttonPanel, "Add CareTaker", e -> displayAddStudentForm(studentTable));
        addButton(buttonPanel, "Edit CareTaker", e -> editSelectedStudent(studentTable));
        addButton(buttonPanel, "Delete CareTaker", e -> deleteSelectedStudent(studentTable));
        addButton(buttonPanel, "Save CareTaker", e -> saveDetailsToDatabase(studentTable));
    ...
    private static void generateReport(JTable studentTable) {
        try {
            ...
            JFreeChart chart = ChartFactory.createBarChart(
                    "Careatakers Report",         // Chart title
                    "Name",                     // X-axis label
                    "No_of_Room",                // Y-axis label
                    dataset,                     // Dataset
            ...
            plot.setDomainAxis(new CategoryAxis("Names"));
            plot.setRangeAxis(new NumberAxis("No of rooms"));

            // Display the chart in a JFrame
            JFrame chartFrame = new JFrame("Careatakers Report");
    ...
    private static CategoryDataset createDataset() throws Exception {
        ...
        String query = "SELECT Name, RegNo FROM students";
        ...
        while (resultSet.next()) {
            ...
            dataset.addValue(RegNo, "RegNo", name);
        }
    ...
    private static void displayEditStudentForm(JTable studentTable, int selectedRow, String[] rowData) {
        JFrame editStudentFrame = new JFrame("Edit Caretaker");
    ...
    private static void displayAddStudentForm(JTable studentTable) {
        JFrame addStudentFrame = new JFrame("Add Caretaker");
    ...
    private static void saveDetailsToDatabase(JTable studentTable) {
        try {
            ...
            String deleteQuery = "DELETE FROM caretakers";
            PreparedStatement deleteStatement = connection.prepareStatement(deleteQuery);
            deleteStatement.executeUpdate();

            // Insert new records
            String insertQuery = "INSERT INTO caretakers (Names, Phone_Number, Salary, No_of_Room, Block, ID_No) VALUES (?, ?, ?, ?, ?, ?)";
