...
public class messmenu {
    ...
    public messmenu() {
        ...
        JFrame studentFrame = new JFrame("messmenu  Details");
    ...
    private static String[][] getInitialData() {
        ...
        try {
            ...
            String query = "SELECT FoodName, FoodId, SerialNumber, Price, Quantity, Times FROM messmenu";
    ...
    private static String[] getColumnNames() {
        return new String[]{"FoodName", "FoodId", "SerialNumber", "Price ", "Quantity", "Times"};
    }
    ...
    private static void generateReport(JTable studentTable) {
        try {
            ...
            JFrame chartFrame = new JFrame("Mess Report");
    ...
    private static DefaultPieDataset createDataset() throws SQLException {
        ...
        try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            String query = "SELECT FoodName, Price FROM messmenu";
            try (ResultSet resultSet = statement.executeQuery(query)) {
                while (resultSet.next()) {
                    String name = resultSet.getString("Foodname");
                    int regNo = resultSet.getInt("Price");
    ...
    private static void displayEditStudentForm(JTable studentTable, int selectedRow, String[] rowData) {
        JFrame editStudentFrame = new JFrame("Edit record");
    ...
    private static void displayAddStudentForm(JTable studentTable) {
        JFrame addStudentFrame = new JFrame("Add record");
        ...
        formPanel.add(new JLabel("FoodName:"));
        formPanel.add(nameField);
        formPanel.add(new JLabel("FoodId:"));
        formPanel.add(regNoField);
        formPanel.add(new JLabel("SerialNumber:"));
        formPanel.add(phoneNumberField);
        formPanel.add(new JLabel("Parent/Guardian Phone.No:"));
        formPanel.add(parentPhoneNumberField);
        formPanel.add(new JLabel("Quantity:"));
        formPanel.add(roomField);
        formPanel.add(new JLabel("Times:"));
        formPanel.add(blockField);
    ...
    private static void saveDetailsToDatabase(JTable studentTable) {
        try {
            ...
            String deleteQuery = "DELETE FROM messmenu";
            PreparedStatement deleteStatement = connection.prepareStatement(deleteQuery);
            deleteStatement.executeUpdate();

            // Insert new records
            String insertQuery = "INSERT INTO messmenu (FoodName, FoodId, SerialNumber, Price, Quantity, Times ) VALUES (?, ?, ?, ?, ?, ?)";
